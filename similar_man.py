...
img2 = cv2.imread('../image/man/auram.jpg')
img3 = cv2.imread('../image/man/glee.jpg')
img4 = cv2.imread('../image/man/qyoung.jpg')
img5 = cv2.imread('../image/man/ttokkii.jpg')
img6 = cv2.imread('../image/man/swan.jpg')
img7 = cv2.imread('../image/man/kisoo.jpg')


#ssh에 바로 사진을 옮겨 실행하기 위한 코드
#img1 = cv2.imread('./sample.jpg')
#img2 = cv2.imread('./auram.jpg')
#img3 = cv2.imread('./glee.jpg')
#img4 = cv2.imread('./qyoung.jpg')
#img5 = cv2.imread('./ttokkii.jpg')
#img6 = cv2.imread('./swan.jpg')
#img7 = cv2.imread('./kisoo.jpg')
...
for j, (name, flag) in enumerate(methods.items()):
    ...
    if __name__ == '__main__' :
        ...
        output = cv2.seamlessClone(np.uint8(img_draw), imgs[similar], mask, center, \
            cv2.NORMAL_CLONE)
        save_file = '../image/man/swap_man.jpg'
